% creating a world object and import the modelled world
...
viewport = vrnode(world, 'east_view');
viewpoint.orientation = [0 1 0 1.5708];
viewpoint.position = [22.6 8 12.];
...
%driving the car from the house to the driveway
for i=1:length(z)  
